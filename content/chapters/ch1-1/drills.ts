...
export const quiz: Question[] = [
  ...
  // source: s3-sse-kms-audit-trail-choice
  {
    ...
    "scenario": "규정 준수 팀이 한 버킷에 대해 두 가지를 요구한다 — 객체를 저장 시 암호화할 것, 그리고 어떤 키를 언제 누가 사용했는지 감사 추적(audit trail)을 남길 것. 키 사용 권한도 IAM/키 정책으로 세밀하게 통제하고 싶다. 가장 적절한 서버측 암호화 방식은?",
    "choices": [
