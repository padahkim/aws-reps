# CONTRACT.md — 콘텐츠 규약 v1 (초안 · 미확정)

> ⚠️ **DRAFT — 이 배너가 있는 동안은 미확정이다.** 확정 절차: 인간이 아래 **[B]** 표시 항목(모듈 구조·명명·로딩·본문 규정 = CONTRACT_PREWORK 기술 결정)을 재확인 → 이 배너 제거 → 정본.
> **[A] = 축1 §E-4 인간 확정(2026-07-14).** **[B] = `docs/CONTRACT_PREWORK.md §1~2` 권장, 기술 확정 대기.**
